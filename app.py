    ...
    with st.form("form_encuesta", clear_on_submit=True):
        ...
        p1 = st.text_area("1) ¿Qué espera usted de una atención en toma de muestras?",
                          max_chars=220, height=100,
                          placeholder="Escribe tu respuesta (máx. 220 caracteres)")
        p2 = st.selectbox("2) ¿Su atención cumplió con sus expectativas (lo que esperaba)?",
                          ["", "Sí", "No", "Parcial"], index=0)
        p3 = st.text_area("3) ¿Cómo podríamos contribuir a mejorar tu experiencia?",
                          max_chars=220, height=100,
